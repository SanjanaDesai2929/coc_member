...
const ClansLeagueRewardsTable = () => {
      ...
      var TableDatatablesManaged = (function () {
        var initTable1 = function () {
            ...
            var table1 = table.DataTable({
                ...
                ajax: {
                    url: `/demo/rtvk/ci_admin_api/coc22game/api/reports/clanLeagueReward?member_id='3'`,
 ...
 <table class="table table-striped datatable-values mt-1 manage_tbl dataTable no-footer" id="manage_tbl">
    ...
    <th class="text-muted border-0 sorting" tabindex="0" aria-controls="manage_tbl" rowspan="1" colspan="1" aria-label="Level: activate to sort column ascending">Level</th>
    <th class="text-muted border-0 sorting" tabindex="0" aria-controls="manage_tbl" rowspan="1" colspan="1" aria-label="Company Turnover Amount: activate to sort column ascending">Company Turnover Amount</th>
...
export default ClansLeagueRewardsTable