...
const EditProfile = () => {
    ...
    const errorData = () => {
        ...
        if (!phone_no) {
            ...
            formIsValid = true;
            formErrors["ponenumberIdErr"] = "Please Invalid Phone Number.";
        }
    ...
    async function from() {
        ...
        formData.append("ponenumber", state.phonenumber)
        formData.append("email", state.email)
        formData.append("countryname", state.country_name)
        formData.append("securitycode", state.security)
                        ...
                        <div className="purple-box text-white text-start purple-budge-body p-5 form-box">
                            ...
                            <form className="form" method="post" name="profile-form-pw" id="profile-form-pw" action="<?php echo base_url(); ?>profile" enctype="multipart/form-data">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="form_input">
                                            <input type="tel" id="phone" maxLength="10" className={`form-control${phonenumberIdErr ? " showError" : ""}`} name="phone_no" onChange={handleChange} value={state.phone_no} placeholder="Enter Phone No" />
                                            <div>
                                                {phonenumberIdErr && (
                                                    <div
                                                        style={{
