                ...
                <div class="col-lg-12 no-padding ">
                    <div class="purple-box table-box py-5 px-4 ">
                        <div class="row align-items-center mb-4">
                            ...
                            <h4 class="table-title text-center text-xl-start mb-xl-0"> League Reward [<a href="#" class="theme-text" data-bs-toggle="modal" data-bs-target="#levelStatus">Check Level</a>]</h4>
                            </div>
                            <div class="col-lg-7 col-md-8 text-md-end text-center ">
                                <span class="balance-info">Total League Reward: 0.00000000 COC</span>
                            </div>
                        </div>
                        <div class="row">
